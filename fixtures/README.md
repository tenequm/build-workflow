...
Not a fixture but the `/review-pr` eval corpus: frozen pull requests with known
defects, scored by `harness.py` (`just eval` from the repository root). See
[its README](review-pr-cases/README.md).
